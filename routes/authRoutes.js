...
router.put('/changeBatch',authMiddleware.requireSignIn,authController.changeBatch);
router.delete('/deleteEnrollment',authMiddleware.requireSignIn,authController.deleteEnrollment);
